...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="d-sm-none d-lg-inline-block">{{auth()->guard('hospital')->user()->name_en}}</div>
                    </a>
            ...
            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                @if(app()->currentLocale() != $localeCode)
                    <a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                        ...
                        <img width="30px" height="20px" src="{{asset('assets/flags/'.$properties['flag'])}}" alt="img">
                    </a>
                @endif
        ...
        @extends('Hospitals.layouts.sidebar')
        ...
        @extends('Hospitals.layouts.footer')

    </div>

</div>

@extends('Hospitals.layouts.script-js')
</body>
</html>
